...
public class SwiftLoader: UIView {
    ...
    class SwiftLoadingView : UIView {
        ...
        */
        ...
        private func drawBackgroundCircle(partial : Bool) {
            ...
            let center : CGPoint = CGPoint(x: self.bounds.size.width / 2,y:
    ...
    */
    public struct Config {
        ...
        */
        public var spinnerColor =  UIColor(colorLiteralRed: 19.0/255.0, green: 65.0/255.0, blue: 102.0/255.0, alpha: 1.0)
        
        /**
        *  S
        */
        public var spinnerLineWidth :Float = 20.0
