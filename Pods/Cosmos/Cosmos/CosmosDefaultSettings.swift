...
struct CosmosDefaultSettings {
  ...
  */
  ...
  /// Color of the text.
  static let textColor = UIColor(red: 245.0/255.0, green: 185.0/255.0, blue: 17.0/255.0, alpha: 1)
  
    //UIColor(red:245.0/255.0, green:185.0/255.0 ,blue:17.0/255.0 , alpha:1.00)
